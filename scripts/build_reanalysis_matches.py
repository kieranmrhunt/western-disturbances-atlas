#!/usr/bin/env python3
"""Match existing legacy WD catalogues to v6 without changing either geometry."""
...
def build():
    reference_path = ROOT.parent / 'catalogue-v6/full-r2/wd_v6-era5-1950-2025-fixes.parquet'
    ...
    for source, (label, filename, truncation) in SOURCES.items():
        ...
        for sid, g in groups.items():
            ...
            for t, row in g.iterrows():
                ...
                candidates.update(int(i) for i in owners[nearby])
    ...
    output = ROOT / 'assets/wd-reanalysis-matches-v1.json.gz'
